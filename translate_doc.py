# -*- coding: utf-8 -*-
content = """# BrewXOS Small Smart Fermentation System - Hardware Recommendations
...
with open(r'C:\Users\xiaomi\Desktop\igem\BrewXOS_Small_Smart_Fermentation_System_Hardware_Recommendations.md', 'w', encoding='utf-8') as f:
    f.write(content)
print(f"Wrote {len(content)} chars to BrewXOS_Small_Smart_Fermentation_System_Hardware_Recommendations.md")
